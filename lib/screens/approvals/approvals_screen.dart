...
class _ApprovalsPageState extends State<ApprovalsPage>
  ...
  Future<void> _fetchHistory({String? search}) async {
    ...
    try {
      ...
      final uri = Uri.parse(
        '$_baseUrl${ApiEndpoints.approvalsHistory}',
      ).replace(queryParameters: queryParams);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const EForwardAppBar(backgroundColor: Colors.white),
      body: SafeArea(
        child: Column(
            ...
            SizedBox(
              ...
              child: Center(
                child: AppEmptyState(
                  ...
                  title: isPending ? "All caught up!" : "No history yet.",
                  subtitle: isPending
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ApprovalCard(
            item: items[index],
            isPending: isPending,
            onTap: () => _handleCardTap(items[index], isPending: isPending),
          );
        },
      ),
    );
